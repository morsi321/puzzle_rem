...
class _WebServices implements WebServices {
  _WebServices(
    ...
    baseUrl ??= 'https://gameserver-5l5f.onrender.com/';
  }
  ...
  @override
  Future<AuthResponse> registerNewUser(RegisterRequest registerRequest) async {
  ...
  Future<List<RankedUser>> getRankedUsers(String token) async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<RankedUser>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => RankedUser.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
